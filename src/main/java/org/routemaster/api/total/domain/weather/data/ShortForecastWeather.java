...
@Builder
@Getter
public class ShortForecastWeather {
    ...
    public static final class ShortForecastWeatherBuilder {

        public ShortForecastWeatherBuilder buildFromJsonNode(JsonNode jsonNode) {
